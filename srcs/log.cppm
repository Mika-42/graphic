...
export namespace mka::graphic {
    ...
    public:
...
#else
        template <typename... Args>
        static void trace(std::source_location, std::string_view, Args &&...) {}

        template <typename... Args>
        static void debug(std::source_location, std::string_view, Args &&...) {}

        template <typename... Args> static void trace(std::string_view, Args &&...) {}
        template <typename... Args> static void debug(std::string_view, Args &&...) {}
#endif
        ...
        static std::source_location
        getContext(std::source_location loc = std::source_location::current()) {
            return loc;
        }
