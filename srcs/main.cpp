...
//  clip1 contient clip2 et D
  ...
  auto l2 = event::link(*rectE.get(), &View::MouseEnter, [&](const MouseEventView&){ Log::debug("Hi !"); });
  auto l3 = event::link(*rectE.get(), &View::MouseLeave, *rectD.get(), &A::onLeave);
